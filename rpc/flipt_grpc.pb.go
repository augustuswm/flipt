...
type FliptClient interface {
	...
	BatchEvaluateLegacy(ctx context.Context, in *BatchEvaluationRequestLegacy, opts ...grpc.CallOption) (*BatchEvaluationResponseLegacy, error)
...
func (c *fliptClient) BatchEvaluateLegacy(ctx context.Context, in *BatchEvaluationRequestLegacy, opts ...grpc.CallOption) (*BatchEvaluationResponseLegacy, error) {
	out := new(BatchEvaluationResponseLegacy)
	err := c.cc.Invoke(ctx, "/flipt.Flipt/BatchEvaluateLegacy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FliptServer interface {
	...
	BatchEvaluateLegacy(context.Context, *BatchEvaluationRequestLegacy) (*BatchEvaluationResponseLegacy, error)
...
func (*UnimplementedFliptServer) BatchEvaluateLegacy(context.Context, *BatchEvaluationRequestLegacy) (*BatchEvaluationResponseLegacy, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchEvaluateLegacy not implemented")
}
...
func _Flipt_BatchEvaluateLegacy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchEvaluationRequestLegacy)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FliptServer).BatchEvaluateLegacy(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flipt.Flipt/BatchEvaluateLegacy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FliptServer).BatchEvaluateLegacy(ctx, req.(*BatchEvaluationRequestLegacy))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Flipt_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BatchEvaluateLegacy",
			Handler:    _Flipt_BatchEvaluateLegacy_Handler,
		},
		{
			MethodName: "GetFlag",
